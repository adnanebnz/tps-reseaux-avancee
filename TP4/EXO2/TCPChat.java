            ...
            case CONNECTED:
               try {
                  ...
                  if (in.ready()) {
                     ...
                     if (firstToken.equals("ADD") || firstToken.equals("MUL") || firstToken.equals("SOUS")
                           || firstToken.equals("DIV") || firstToken.equals("PUIS")) {
                        ...
                        switch (firstToken) {
                           ...
                           case "DIV":
                              if (operand2 == 0) {
                                 appendToChatBox("Division par zero impossible\n");
                                 break;
                              }
